...
from lab.rag.eval import EvalQuestion, EvalResult, RAGEvaluator
...
class TestQAGrounding:
    ...
    def test_qa_result_metadata(self):
        ...
        mock_passages = [{"id": "passage_1", "content": "Test content", "score": 0.9}]
        self.mock_retriever.retrieve.return_value = mock_passages
    ...
    def test_eval_result_grounding_check(self):
        ...
        question = EvalQuestion(question="What is the test?", expected_answer="This is a test")
    ...
    def test_deterministic_evaluation(self):
        ...
        mock_qa_module = Mock()
        mock_qa_module.query.return_value = QAResult("Q1", "A1", [{"id": "p1"}], ["p1"], 0.8, {})
