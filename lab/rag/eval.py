...
class RAGEvaluator:
    ...
    def run_evaluation(self, questions: list[EvalQuestion] | None = None) -> EvalMetrics:
        ...
        logger.info(
            f"Evaluation complete: {metrics.accuracy:.2%} accuracy, {metrics.grounding_rate:.2%} grounding",
        )
        return metrics
...
def run_eval(
    config_path: str = "lab/rag/config.yaml",
